...
<div class="container-fluid">
    ...
    <h4 class="text-center">Bienvenue <strong> MONSIEUR / MADAME ADMIN</strong> </h4>
    <div class="card mb-4 mt-3">
        ...
        <div class="card-body">
            ...
            <div class="card-body">
                <a class="text-primary" href=""><i class="fa fa-edit"></i> Modifier Votre info</a>

                <a class="text-primary" href=""><i class="fa fa-edit"></i> Modifier le mot de passe</a>
            </div>
        </div>
    </div>
</div>
